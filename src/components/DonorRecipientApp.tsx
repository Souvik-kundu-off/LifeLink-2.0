...
export default function DonorRecipientApp({ user, onLogout }: DonorRecipientAppProps) {
  ...
  const mockDonationRequests = [
    ...
    },
    {
      ...
      description: 'Patient scheduled for surgery, needs compatible blood for transfusion'
    }
  ];
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  <Badge variant="outline" className="font-mono">{mockProfile.bloodGroup}</Badge>
                </div>
              </div>
              
              <div className="space-y-2">
                <span className="text-sm font-medium">Last donation:</span>
                <p className="text-sm text-gray-600">{mockProfile.lastDonation}</p>
              </div>
            </div>
